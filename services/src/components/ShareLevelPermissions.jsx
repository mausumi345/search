...
import {
  ...
  FlexLayout, Checkbox, FormLayout, Select, Button, TextLabel, InputPlusLabel, RadioGroup, Radio
} from 'prism-reactjs';
...
const i18nT = (key, defaultValue, replacedValue) => i18n.getInstance().t(
  'ShareLevelPermissions', key, defaultValue, replacedValue);
  ...
  render() {
    ...
    const body = (
      <StackingLayout>
        ...
        />
        <InputPlusLabel label="Destination Files directory path" id="desDirPath" placeholder="e.g. /dir1/"
          onChange={this.handleInputChange} />
        <Checkbox id="applyRecursive" type="toggle" label="Apply Recursively" checked={this.state.applyRecursive}
          onChange={e => { this.checkboxOnClick('applyRecursive', e) }} />
        <RadioGroup defaultValue="allow" id="allowDeny" layout="horizontal" onChange={this.handleOnChange}>
